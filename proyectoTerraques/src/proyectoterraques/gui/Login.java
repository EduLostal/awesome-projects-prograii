...
public class Login {
    public static void main(String[] args) {
        ...
        FileHandler file_banks = new FileHandler();
        FileHandler file_employees = new FileHandler();
        ...
        do {
            ...
            if (option==1){
                ...
                for (String bank: file_banks.loadFileContent(path)){
                ...
                for (String employee: file_employees.loadFileContent(path)){
